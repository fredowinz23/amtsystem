            ...
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tbody>
											...
											<?php if (cbc()->count("patient_id='$patient_id'")>0) {
														$count = 0;
				                        ...
				                        <tr>
				                            ...
				                            <td align="right">
																			<button class="btn btn-round" style="<?=button_color()[2]?>"
																					onclick="location.href='?view=CBC_display&Id=<?=$row->Id;?>'"
																				>
						                        ...
						                        <tr>
						                            ...
						                            <td align="right">
																					<button class="btn btn-round" style="<?=button_color()[2]?>"
																							onclick="location.href='?view=CSC_display&Id=<?=$row->Id;?>'"
																						>
															              <i class="material-icons">visibility</i> View
															            </button>
						                            </td>
							                        ...
							                        <tr>
							                            ...
							                            <td align="right">
																						<button class="btn btn-round" style="<?=button_color()[2]?>"
																								onclick="location.href='?view=UA_display&Id=<?=$row->Id;?>'"
																							>
																              <i class="material-icons">visibility</i> View
																            </button>
							                            </td>
								                        ...
								                        <tr>
								                            ...
								                            <td align="right">
																							<button class="btn btn-round" style="<?=button_color()[2]?>"
																									onclick="location.href='?view=SQAR_display&Id=<?=$row->Id;?>'"
																								>
																	              <i class="material-icons">visibility</i> View
																	            </button>
								                            </td>
																	...
																	foreach(hiv()->list("patient_id='$patient_id'") as $row) {
																		...
																		?>
																			<tr>
																					...
																					<td align="right">
																						<button class="btn btn-round" style="<?=button_color()[2]?>"
																								onclick="location.href='?view=HIV_display&Id=<?=$row->Id;?>'"
																							>
																							<i class="material-icons">visibility</i> View
																						</button>
																					</td>
																		...
																		foreach(ksa()->list("patient_id='$patient_id'") as $row) {
																			...
																			?>
																				<tr>
																						...
																						<td align="right">
																							<button class="btn btn-round" style="<?=button_color()[2]?>"
																									onclick="location.href='?view=KSA_display&Id=<?=$row->Id;?>'"
																								>
																								<i class="material-icons">visibility</i> View
																							</button>
																						</td>
